...
@InputType()
class TransactionsCreateNestedManyWithoutItemsCatalogsInput {
...
export { TransactionsCreateNestedManyWithoutItemsCatalogsInput as TransactionsCreateNestedManyWithoutItemsCatalogsInput };
