...
@InputType()
class TransactionsUpdateManyWithoutItemsCatalogsInput {
...
export { TransactionsUpdateManyWithoutItemsCatalogsInput as TransactionsUpdateManyWithoutItemsCatalogsInput };
