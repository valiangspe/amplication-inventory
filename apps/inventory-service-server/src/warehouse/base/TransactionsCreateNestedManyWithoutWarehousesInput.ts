...
@InputType()
class TransactionsCreateNestedManyWithoutWarehousesInput {
...
export { TransactionsCreateNestedManyWithoutWarehousesInput as TransactionsCreateNestedManyWithoutWarehousesInput };
